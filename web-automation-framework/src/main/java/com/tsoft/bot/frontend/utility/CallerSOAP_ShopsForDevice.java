...
public class CallerSOAP_ShopsForDevice {

    private static final String EXCEL_SERVICE = "excel/Service_Agile2.xlsx";
    ...
    public static void Ejecutable() throws Throwable {
        ...
        ExtentReportUtil.INSTANCE.stepInfo(driver, "El Tag de validación es serviceName: "+getValueTagXML(detailResponse(url, resquest), "serviceName", 0));
    }
...
//
            ...
            if (responseStatus == 200) {
                ...
                if(response.toString().equals("Connection timed out: connect")){
