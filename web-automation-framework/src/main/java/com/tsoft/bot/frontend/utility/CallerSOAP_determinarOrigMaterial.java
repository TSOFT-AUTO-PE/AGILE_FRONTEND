...
public class CallerSOAP_determinarOrigMaterial {

    private static final String EXCEL_SERVICE = "excel/Service_Agile3.xlsx";
    ...
    public static void Ejecutable() throws Throwable {
        ...
        getValueTagXML(detailResponse(url, resquest), "sapId", 0);
        ExtentReportUtil.INSTANCE.stepInfo(driver, "El Tag de validación es sapId: "+getValueTagXML(detailResponse(url, resquest), "sapId", 0));
    }
