...
public class CallerSOAP_RM3getUnifiedResourceDetails_ResourceSIM {

    private static final String EXCEL_SERVICE = "excel/Service_Agile9.xlsx";
    ...
    public static void Ejecutable() throws Throwable {
        ...
        getValueTagXML(detailResponse(url, resquest), "faultcode", 0);
        ExtentReportUtil.INSTANCE.stepInfo(driver, "El Tag de validación es faultcode: "+getValueTagXML(detailResponse(url, resquest), "faultcode", 0));
    }
