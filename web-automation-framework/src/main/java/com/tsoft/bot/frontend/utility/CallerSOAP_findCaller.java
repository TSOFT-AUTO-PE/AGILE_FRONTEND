...
public class CallerSOAP_findCaller {

    private static final String EXCEL_SERVICE = "excel/Service_Agile5.xlsx";
    ...
    public static void Ejecutable() throws Throwable {
        ...
        getValueTagXML(detailResponse(url, resquest), "customerName", 0);
        ExtentReportUtil.INSTANCE.stepInfo(driver, "El Tag de validación es customerName: "+getValueTagXML(detailResponse(url, resquest), "customerName", 0));
    }
