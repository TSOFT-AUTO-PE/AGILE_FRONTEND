...
public class CallerSOAP_RM3getUnifiedResourceDetails {

    private static final String EXCEL_SERVICE = "excel/Service_Agile6.xlsx";
    ...
    public static void Ejecutable() throws Throwable {
        ...
        getValueTagXML(detailResponse(url, resquest), "categoryType", 0);
        ExtentReportUtil.INSTANCE.stepInfo(driver, "El Tag de validación es categoryType: "+getValueTagXML(detailResponse(url, resquest), "categoryType", 0));
    }
